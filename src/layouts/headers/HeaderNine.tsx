...
import diego_logo from '@/assets/img/logo/logo-white.png';
import Offcanvas from '@/components/common/Offcanvas';


const HeaderNine = ({style_2}: any) => {
  ...
  return (
    <>
      <header>        
        <div className={`tp-header-3__area tp-header-transparent tp-header-3__ptlr ${style_2 ? 'tp-header-5-top-space' : 'slider-pt'}`}>
          <div className="container container-1720">
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  <Link href="/"><Image src={diego_logo} alt="image-here" /></Link>
                </div>
              </div>
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__right-action d-flex align-items-center justify-content-end">
                  <div className="tp-header-3__bar tp-magnetic-wrap">
                    <button className="tp-menu-bar tp-offcanvas-open-btn tp-magnetic-item not-hide-cursor tp-toggle-btn-box" 
