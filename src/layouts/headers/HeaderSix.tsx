...
const HeaderSix = ({style_bg} : any) => {
  ...
  return (
    <>
      <header> 
        <div className={`tp-header-3__area tp-header-transparent tp-header-3__ptlr tp-header-5-style ${style_bg ? 'tp-header-5-inner-style' : ''}`}>
          <div className="container container-1720">
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  <Link className="logo-white" href="/"><Image src={logo} alt="image-here" /></Link>
                  <Link className="logo-black" href="/"><Image src={logo} alt="image-here" /></Link>
                </div>
              </div>
                      ...
                      <span className="light">
                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                          ...
                          <path
                            ...
                            fill="currentColor" />
                          <path d="M10 1V2.63636" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                            strokeLinejoin="round" />
                          <path d="M10 17.3637V19.0001" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                            strokeLinejoin="round" />
                          <path d="M3.63477 3.63455L4.79658 4.79637" stroke="currentColor" strokeWidth="2"
                            strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M15.2031 15.2036L16.3649 16.3654" stroke="currentColor" strokeWidth="2"
                            strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M1 10.0001H2.63636" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                            strokeLinejoin="round" />
                          <path d="M17.3652 10.0001H19.0016" stroke="currentColor" strokeWidth="2"
                            strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M3.63477 16.3654L4.79658 15.2036" stroke="currentColor" strokeWidth="2"
                            strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M15.2031 4.79637L16.3649 3.63455" stroke="currentColor" strokeWidth="2"
                            strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </span>
                    </label>
      ...
      <header>
        <div className="tp-header-3__area tp-header-transparent tp-header-3__ptlr tp-int-menu tp-header-5-sticky-bg tp-header-sticky-cloned">
      ...
      <Offcanvas showCanvas={showCanvas} setShowCanvas={setShowCanvas} style_bg2={true} />
    </>
  );
};
