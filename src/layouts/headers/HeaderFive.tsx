...
import logo_red from "@/assets/img/logo/logo-red.png"
...
const HeaderFive = () => {
  ...
  return (
    <>
      <header>
        <div className="tp-header-3__area header-white-style-2 tp-header-transparent tp-header-3__ptlr">
            ...
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  ...
                  <Link className="logo-black" href="/"><Image src={logo_red} alt="image-here" /></Link>
                </div>
              </div>
      ...
      <header>
        <div className="tp-header-3__area tp-header-transparent tp-header-3__ptlr tp-int-menu tp-header-4-sticky-bg tp-header-sticky-cloned">
          <div className="container-fluid">
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
