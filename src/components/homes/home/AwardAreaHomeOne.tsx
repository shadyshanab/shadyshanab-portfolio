...
const personal_content: DataType = {
    ...
    experience_data: [
        {
            ...
            company : "MeetNTrain",
            time : "2024 - Present",
            description : "As a Front End Developer at MeetNTrain, I contributed to developing a social platform that connects users with similar interests and facilitates event planning. My role involved crafting intuitive user interfaces and seamless interactions for the platform, enabling users to explore events, connect with others, plan outings, purchase tickets, share memories, stay informed, engage with organizers, and host their events.",
        },
        {
            id: 2,
            designation : "Front End Developer",
    ...
    education_data: [
        {
            id: 1,
            collage : "Bachelor of Computer Science",
            designation : "Arab Academy For Science, Technology and Maritime",
            time : "2019 - 2023",
...
const { subtitle, title, email, phone, skillsets_data, experience_data, education_data,certificates_data } = personal_content
                  ...
                  <div className="ab-personal-info__exprience mb-85 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
                    ...
                    <span>
                      ...
                      {education_data.map((item, index) => (
                          <div key={index} className="ab-personal-info__exprience-box d-flex align-items-start z-index-2">
                              <span className="ab-personal-info__exprience-length">{item.time}</span>
                              <div className="ab-personal-info__exprience-content">
                                  <h4 className="ab-personal-info__exprience-title" style={{lineHeight:'30px'}}>{item.designation}</h4>
                                  <span>{item.collage}</span> <br/>
                                    <span>{item.description}</span>
                              </div>
                          </div>
                      ))}
                  ...
                  <div className="ab-personal-info__exprience mb-85 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
                    ...
                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none"
                      ...
                      {certificates_data.map((item, index) => (
                          <div key={index} className="ab-personal-info__exprience-box d-flex align-items-start ">
                              <span className="ab-personal-info__exprience-length">{item.date}</span>
                              <div className="ab-personal-info__exprience-content">
                                  <h4 className="ab-personal-info__exprience-title" style={{lineHeight:'30px'}}>{item.title}</h4>
